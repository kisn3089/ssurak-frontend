...
export default function TriggerSelect() {
  return (
    <SelectTrigger
      type="button"
      className="w-20 border-blue-primary-edge text-blue-primary-foreground font-semibold hover:bg-blue-50 hover:border-blue-300 dark:hover:bg-slate-800 dark:hover:border-blue-600"
